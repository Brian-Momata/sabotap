 ...
 * concurrent matches); voice signaling is delegated to VoiceChannel, and
 * disconnect grace/resume lives in reconnect.js. State fields persisted
 * across server restarts are mirrored in serialize.js — extend it when
 * adding room/match state.
 */
class Room {
